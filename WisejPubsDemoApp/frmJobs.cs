...
namespace WisejPubsDemoApp
{
    public partial class frmJobs : Form
    {
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_Dbo_Jobs.Init(DbConfig);
            this.dbT_Dbo_Jobs.DataBinding = BasicDAL.DataBoundControlsBehaviour.BasicDALDataBinding;
            ...
            this.dbT_Dbo_Jobs.DbC_job_id.BoundControls.Add(this.txt_job_id, "text", BasicDAL.BindingBehaviour.WriteAddNew);
            this.dbT_Dbo_Jobs.DbC_job_desc.BoundControls.Add(this.txt_job_desc, "text", BasicDAL.BindingBehaviour.WriteAddNew);
            this.dbT_Dbo_Jobs.DbC_max_lvl .BoundControls.Add(this.txt_max_lvl, "text");
            this.dbT_Dbo_Jobs.DbC_min_lvl.BoundControls.Add(this.txt_min_lvl, "text");
            
            this.dataNavigator1.DbObject = this.dbT_Dbo_Jobs;
        ...
        private void  qbe_Jobs()
        {
        DbT_dbo_jobs  QBEDbObject = new  DbT_dbo_jobs ();
        ...
        QBEForm.QueryDbObject = this.dbT_Dbo_Jobs;
        QBEForm.AutoLoadAll = true;
        QBEForm.DbColumnsMapping.Add(QBEDbObject.DbC_job_id , this.dbT_Dbo_Jobs .DbC_job_id );
