...
namespace WisejPubsDemoApp
{
    public partial class frmStores : Form
    {
        ...
        DbT_dbo_stores dbT_dbo_stores = new  DbT_dbo_stores ();
        ...
        private void Init(bool ForceFormInit = false)
        {
            ...
            this.dbT_dbo_stores .DataBinding = BasicDAL.DataBoundControlsBehaviour.BasicDALDataBinding;
            this.dbT_dbo_stores.Init(this.appConfig.DbConfig);

            this.dbT_dbo_stores.DbC_stor_id.BoundControls.Add(this.txt_stor_id, "text");
            this.dbT_dbo_stores.DbC_city.BoundControls.Add(this.txt_city, "text");
            this.dbT_dbo_stores.DbC_state .BoundControls.Add(this.txt_zip, "text");
            this.dbT_dbo_stores.DbC_stor_address.BoundControls.Add(this.txt_stor_address, "text");
            this.dbT_dbo_stores.DbC_stor_name .BoundControls.Add(this.txt_stor_name, "text");
            this.dbT_dbo_stores.DbC_zip.BoundControls.Add(this.txt_zip, "text");
            ...
            this.dbT_dbo_stores .Open(true);

            this.dataNavigator1.DbObject = this.dbT_dbo_stores;
        ...
        private void dataNavigator1_eFind()
        {
            ...
            QBEForm.QueryDbObject = this.dbT_dbo_stores;
            QBEForm.AutoLoadAll = true;
            QBEForm.UseExactSearchForString = false;
            QBEForm.DbColumnsMapping.Add(QBEDbObject.DbC_stor_id, this.dbT_dbo_stores.DbC_stor_id);
